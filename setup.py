...
DATA_FILES = ['./Audio/aughhhhh.mp3', './Audio/augh_shortened.mp3', './Audio/augh_compressed_sped_up.mp3', './Cat GIFs/idle.GIF', './Cat GIFs/jumpLeft.GIF',
              './Cat GIFs/jumpRight.GIF', './Cat GIFs/jumpUp.GIF', './Cat GIFs/rollLeft.GIF', './Cat GIFs/rollRight.GIF', './Cat GIFs/screm.GIF', './SussyMeowmeow/Audio/augh_compressed_sped_up.wav']
OPTIONS = {
        'iconfile': 'icon.icns',
